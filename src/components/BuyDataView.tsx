...
const BuyDataView = ({
  ...
  return <div className="min-h-screen bg-gray-50">
      ...
      <div className="-mt-6 my-0 py-[31px] px-[24px]">
          ...
          <Tabs defaultValue="hot" className="w-full" onValueChange={setSelectedTab}>
            ...
            {Object.entries(dataPlansByCategory).map(([category, plans]) => <TabsContent key={category} value={category} className="mt-6">
                <div className="grid grid-cols-2 gap-4">
                  {plans.map(plan => <button key={plan.id} onClick={() => handlePlanSelection(plan)} className="bg-gray-50 rounded-xl p-4 text-center space-y-2 hover:bg-gray-100 transition-colors opacity-70 cursor-not-allowed" disabled>
